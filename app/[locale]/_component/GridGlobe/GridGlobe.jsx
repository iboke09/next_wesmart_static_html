...
const World = React.memo(dynamic(() => import("../../../components/ui/globe").then((m) => m.World), {
  ssr: false,
}));
...
function GlobeDemo() {
  ...
  return (
    (<div
      className="flex flex-row items-center justify-center py-20 h-screen lg:h-auto bg-transparent relative w-full globecssapp">
      <div
        ...
        <motion.div
          ...
          className="div" style={{userSelect:"none"}}>
          {/* <h2
        ...
        <div className="absolute w-full  h-72 md:h-full z-10 globecss" style={{bottom:"3rem"}}>
