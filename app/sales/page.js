            ...
            <div className="container">
                ...
                <div className='container'>
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8 maskat" style={{ position: "relative", top: "120px" }}>
                        <div className='' style={{ display: "flex", justifyContent: "center" }}><Suspense fallback={<Loading/>}><Image load='eager'className='sura' alt={"Sap"} src={image} width={400} height={400} style={{
